...
func (m *Instance) GetCats(params map[string]interface{}, postData map[string]interface{}) []Cat {
	var results []Cat
...
func (m *Instance) UpdateCats(data map[string]interface{}, id int) (sql.Result, error) {
