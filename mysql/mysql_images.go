...
func (m *Instance) GetImgTakeFree(siteId int, keyword string, s bool) Image {
	var image Image
	var source string
	if s {
		source = "1"
...
func (m *Instance) UpdateImg(data map[string]interface{}, id int) (sql.Result, error) {
...
func (m *Instance) AddImg(data map[string]interface{}) (sql.Result, error) {
