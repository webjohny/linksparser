...
func CreateWpPostTmpl(data map[string]interface{}) string {
	tmpl := `
		<!-- wp:html -->
		<div class="custom-article">
			<div class="ca-header">
				<div class="ca-header-content">
					<div class="ca-header-user">
						<figure style="background: url('` + data["avatar"].(string) + `') no-repeat center / cover;"></figure>
						<p class="ca-header-by">Asked by: ` + data["author"].(string) + `</p>
						<div class="ca-header-tag red">Questioner</div>
						<div class="ca-header-tag blue">General</div>
					</div>
					<h1 class="ca-header-title">` + data["keyword"].(string) + `</h1>
					<p class="ca-header-description">` + data["content"].(string) + `</p>
					<div class="ca-header-date">
						<img src="http://testwp.com/wp-content/uploads/2021/02/date.png" />
						<p>Last Updated: ` + data["date"].(string) + `</p>
					</div>
				</div>
			...
			<div class="ca-text">
				...
				<ul>
					<li><b>Step 1.</b> Go to <a href="#">Oiiaq Login</a> page via official link below.</li>
					<li><b>Step 2.</b> Login using your username and password. Login screen appears upon successful login.</li>
					<li><b>Step 3.</b> If you still can't access Oiiaq Login then see <a href="#">Troublshooting options here</a>.</li>
				</ul>
			</div>
			<div class="ca-list">
				<div class="ca-list-item">
					<div class="ca-list-item-row">
						<a class="ca-list-item-img" href="#"><img src="http://testwp.com/wp-content/uploads/2021/02/noname.jpeg" /></a>
						<div class="ca-list-item-content">
							<div class="ca-list-item-user">
								...
								<p class="ca-list-item-by">Asked by: Jeremie Isaacson</p>
								<div class="ca-list-item-tag">Explainer</div>
							</div>
							<p class="ca-list-item-title">Ordre des infirmières et infirmiers auxiliaires du Québec | OIIAQ</p>
							<p class="ca-list-item-link">https://www.oiiaq.org/login</p>
							<p class="ca-list-item-text">L'Ordre des infirmières et infirmiers auxiliaires du Québec (OIIAQ) est un organisme à but non lucratif qui regroupe plus de 28 000 membres à travers le Québec.</p>
						</div>
					</div>
					<div class="ca-list-item-info">
						<div class="ca-list-item-info-item">
							<p class="ca-list-item-info-item-value"><span style="background: #f0ad4e;">1,086,387</span></p>
							<p class="ca-list-item-info-item-text">Global Rank</p>
						</div>
						<div class="ca-list-item-info-item">
							<p class="ca-list-item-info-item-value"><span style="background: #495b79;">90,755</span></p>
							<p class="ca-list-item-info-item-text">Pageviews</p>
						</div>
						<div class="ca-list-item-info-item">
							<p class="ca-list-item-info-item-value"><img src="http://testwp.com/wp-content/uploads/2021/02/us.png" /> <span style="color: #000;">N/A</span></p>
